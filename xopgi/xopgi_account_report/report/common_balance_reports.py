        ...
        for account in accounts:
            if init_balance:
                ...
                if child_ids:
                    ...
                    # child_currency_init_balances = [
                    #     init_bal['init_balance_currency']
                    #     for acnt_id, init_bal in init_balance.iteritems()
                    #     if acnt_id in child_ids]
                    # top_init_balance_currency = reduce(add, child_currency_init_balances)
                    # account['init_balance_currency'] = top_init_balance_currency
